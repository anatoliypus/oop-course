...
fc FailSample1.txt %TEMP%\output.txt > null || goto err
echo Test 3 passed

REM Different lines in files test
%Program% File5.txt File6.txt > %TEMP%\output.txt
fc FailSample2.txt %TEMP%\output.txt > null || goto err
echo Test 4 passed
